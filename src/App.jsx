...
function App() {
  ...
  return (
    <container >
    <div className=" grid grid-cols-1 grid-rows-3 grid-rows-[300px_1fr_minmax(0,656px)] bg-[#F5EBE0] ">
      <header className="" >
      ...
      <main className=" px-[30px]">
        ...
        <section className="grid grid-cols-1 grid-rows-4 mt-[2em] bg-[#E9EDC9]   md:grid-cols-2 md:bg-[#F5EBE0] md:gap-x-[6%] md:grid-cols-[repeat(2,minmax(0,532px))]md:w-[90%] lg:w-[80%] xl:w-[60%] mx-auto "> 
